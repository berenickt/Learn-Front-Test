    ...
    <Box mt={2}>
      ...
      <TableContainer component={Paper}>
        <Table size="small">
          <TableBody>
            <TableRow>
              <TableCell style={{ fontWeight: 'bold', width: '30%' }}>총상품가격</TableCell>
            ...
            <TableRow>
              <TableCell style={{ fontWeight: 'bold', width: '30%' }}>배송비</TableCell>
              <TableCell>{formatPrice(shippingCost)}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell style={{ fontWeight: 'bold', width: '30%' }}>총결제금액</TableCell>
              <TableCell>
                {getTotalPrice({
